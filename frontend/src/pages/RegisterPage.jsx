...
import { Trophy, Mail, Lock, User, ArrowRight, Chrome, Eye, EyeOff } from 'lucide-react';
                ...
                <div className="relative z-10 max-w-lg space-y-12 animate-fade-in-up">
                    ...
                    <div className="space-y-6">
                        <h2 className="text-4xl font-black tracking-tight leading-tight uppercase italic">
                            Initialize your <br />
                            <span className="text-emerald-400 underline decoration-emerald-800/50 underline-offset-8">Growth Cycle</span>
                        </h2>
                        <p className="text-slate-400 font-medium text-lg leading-relaxed italic border-l-4 border-emerald-500/30 pl-6">
                            "The journey to peak performance starts with an intentional first step. Automate your progress tracking today."
                        </p>
                    </div>
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center items-center px-4 sm:px-10 md:px-20 py-12 bg-white relative">
                ...
                <div className="w-full max-w-sm space-y-8 md:space-y-10 animate-fade-in-up mt-8 md:mt-0">
                    ...
                    <div className="space-y-3 md:space-y-4">
                        <h2 className="text-2xl md:text-3xl font-black text-slate-900 tracking-tight uppercase italic leading-none">Create a new identity</h2>
                        <p className="text-[9px] md:text-[10px] font-bold text-slate-400 uppercase tracking-widest pl-0.5">Begin your progress tracking journey</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="space-y-2">
                            <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest pl-1">Full Identity Name</label>
                        ...
                        <div className="space-y-2">
                            <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest pl-1">Terminal Address</label>
                            <div className="relative focus-within:ring-2 focus-within:ring-emerald-500/10 rounded-2xl transition-all">
                        ...
                        <div className="space-y-2">
                            <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest px-1 pl-1">Secret Key</label>
                            <div className="relative focus-within:ring-2 focus-within:ring-emerald-500/10 rounded-2xl transition-all">
                        ...
                        {localError && (
                            <div className="bg-rose-50 text-rose-600 text-[10px] font-black py-4 px-6 rounded-2xl border border-rose-100 animate-shake">
                                ⚠️ Initialization Error: {localError}
                            </div>
                        )}
                        ...
                        >
                            {authLoading ? (
                                ...
                                <>
                                    <span className="uppercase tracking-[0.2em] text-xs">Create Profile</span>
                    ...
                    <div className="pt-6 text-center">
                        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                            ...
                            <Link to="/login" className="text-emerald-600 hover:underline font-black">Authorize Session</Link>
                        </p>
                    </div>
                </div>
            </div>
